...
public abstract class WindowColetor {
	...
	protected ToolItem tltmPesquisarComunidade;
	protected Composite composite;
	protected DateChooserCombo dateChooserCombo;

	public static void main(String[] args) {
		try {
			WindowColetor window = new WindowColetor() {
			};
	...
	protected void createContents() {
		...
		tltmPesquisarComunidade = new ToolItem(toolBar_1, SWT.NONE);
		tltmPesquisarComunidade.setImage(SWTResourceManager.getImage("./icones/search.png"));
		tltmPesquisarComunidade.setText("Pesquisar");

		textComunidade = new Text(composite, SWT.BORDER);
		textComunidade.setEnabled(false);
		textComunidade.setBackground(SWTResourceManager.getColor(SWT.COLOR_CYAN));
		textComunidade.setBounds(135, 232, 257, 21);

		Label lblComunidade = new Label(composite, SWT.NONE);
		lblComunidade.setText("Comunidade");
		lblComunidade.setBackground(SWTResourceManager.getColor(SWT.COLOR_WIDGET_LIGHT_SHADOW));
		lblComunidade.setBounds(30, 232, 78, 15);
