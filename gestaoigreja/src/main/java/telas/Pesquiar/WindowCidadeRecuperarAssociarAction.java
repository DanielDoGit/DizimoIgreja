...
public class WindowCidadeRecuperarAssociarAction extends WindowCidadeRecuperarAssociar{
	...
	public WindowCidadeRecuperarAssociarAction() {
				...
				if (!text.getText().isEmpty()) {
					...
					try {
							...
							if (combo.getSelectionIndex() == 0) {
								...
								List<Cidade> listacidade =  c.consultarCidadeUF(co);
								if(listacidade != null) {
									for (Cidade cc : listacidade) {
