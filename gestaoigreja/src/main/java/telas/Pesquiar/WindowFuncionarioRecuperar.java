...
public abstract class WindowFuncionarioRecuperar {
	...
	public static void main(String args[]) {
		try {
			...
			WindowFuncionarioRecuperar shell = new WindowFuncionarioRecuperar() {
			};
	...
	protected void createContents() {
		...
		shell.setText("Pesquisar Funcionário");
		...
		tblclmnCidadeDoColetor.setText("Cidade do Funcionario");
		
		tblclmnComunidade = new TableColumn(table, SWT.NONE);
		tblclmnComunidade.setWidth(231);
		tblclmnComunidade.setText("Categoria");
