...
public class IdentificacaoUsuarioSWT extends Dialog {
	 ...
	 * @param style
	 */
	public IdentificacaoUsuarioSWT(Shell parent, int style) {
		super(parent, style);
		setText("SWT Dialog");	
	}
	...
	private void createContents() {
		...
		btnNewButton.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				new LoginFuncionarioActionSWT().open();
		...
		btnNewButton_1.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				// TODO Auto-generated method stub
				shlBoasVindasAo.dispose();
				new LoginColetorActionSWT().open();
