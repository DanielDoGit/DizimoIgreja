...
public class CadastroDizimistaActionDeprecied extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CadastroDizimistaActionDeprecied frame = new CadastroDizimistaActionDeprecied();
	 ...
	 */
	public CadastroDizimistaActionDeprecied() throws ParseException {
		setResizable(false);
